...
Note on my Seminar #4: For this final seminar, we chose to make a hangman game program which uses a kernal module to help give us the random word the user will need to guess.
